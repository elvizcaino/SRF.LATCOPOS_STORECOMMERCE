...
namespace Contoso.Commerce.RetailProxy.Extension
{
    ...
    /// </summary>
    [GeneratedCodeAttribute("Contoso.Commerce.RetailProxy.Extension", "1.0")]
    public interface ILATCOBasicDocumentTypeEntityManager : IEntityManager
    {
        ...
        Task<PagedResult<LATCOBasicDocumentTypeEntity>> GetAllLATCOBasicDocumentTypeEntities(QueryResultSettings queryResultSettings = null);
