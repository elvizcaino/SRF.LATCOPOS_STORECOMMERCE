...
*/
namespace SRF.CommerceRuntime.Triggers
{
        ...
        public async Task OnExecuted(Request request, Response response)
        {
            switch (request)
            {
                case GetChannelConfigurationDataRequest originalRequest:
                    if (response is SingleEntityDataServiceResponse<ChannelConfiguration> data && data.Entity != null && data.Entity.GetProperty(PropertyKey) == null)
                    {
